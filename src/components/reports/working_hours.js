...
const WorkingHours = ({getDeviceList,device:{deviceList,loading}}) => {
  useEffect(() => {
    getDeviceList()
  }, [])
      ...
      <div className={classes.table}>
        <MaterialTable
          ...
          columns={[
            ...
            { title: "First Activity", field: "date" },
            { title: "Last Actvity", field: "online" },
            { title: "Last Actvity Log", field: "deviceName" },
            { title: "Total Time", field: "userName" },
            { title: "Active Status", field: "date" },
            { title: "Action Tye", field: "online" },
          ]}
          data={deviceList}
          options={{
              search:false,
...
export default connect(mapStateToProps,{getDeviceList})(WorkingHours)
